...
class SpeechToTextManager:
    ...
    def __init__(self):
        ...
        try:
            self.azure_speechconfig = speechsdk.SpeechConfig(subscription=os.getenv('AzureTTS_API_Key'), region=os.getenv('AzureTTS_Region'))
        except TypeError:
            exit("You forgot to set AZURE_TTS_KEY or AZURE_TTS_REGION in your environment!")
